...
resource "aws_s3_bucket_notification" "s3_trigger" {
  bucket = aws_s3_bucket.s3-serverless-video-upload-python.id  # Replace with your S3 bucket ID
  lambda_function {
    lambda_function_arn = aws_lambda_function.twentyfour-hour-video-python-transcode-video.arn
