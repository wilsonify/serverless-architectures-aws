resource "aws_lambda_function" "hello-world-dev-hello" {
...
resource "aws_lambda_function" "twentyfour-hour-video-dev-transcode-video" {
  architectures = ["x86_64"]
...
resource "aws_lambda_function" "twentyfour-hour-video-python-dev-custom-resource-existing-s3" {
  architectures                  = ["x86_64"]
...
resource "aws_lambda_function" "twentyfour-hour-video-python-dev-transcode-video" {
  architectures = ["x86_64"]
